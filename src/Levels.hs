...
-- Internal imports`
import Constants (blockHeight, blockSeparation, blockWidth,
                  gameAreaMinLeftMargin, gameAreaTopMargin, gameWidth,
                  maxBlockLife, minBlockLife)
import Objects   (AlwaysPowerUp,
